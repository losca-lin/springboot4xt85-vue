      ...
      <el-form class="center-form-pv" :style='{"margin":"0 0 0px"}' :inline="true" :model="searchForm">
        ...
        <el-row
          ...
          <el-button
              ...
              v-if="isAuth('chanpinleixing','新增')" type="success" @click="addOrUpdateHandler()">新增
          </el-button>
          <el-button
              :style='{"border":"0","cursor":"pointer","padding":"0 16px","margin":"0 10px 6px 0","borderColor":"#666","color":"#333","outline":"none","borderRadius":"0px","background":"#f9c535","borderWidth":"0 0 0px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"36px"}'
              v-if="isAuth('chanpinleixing','删除')" :disabled="dataListSelections.length <= 0" type="danger"
        ...
        <el-table-column width="300" label="操作">
          <template slot-scope="scope">
            <el-button
                ...
                v-if=" isAuth('chanpinleixing','查看')" type="success" size="mini"
            ...
            <el-button
                ...
                v-if=" isAuth('chanpinleixing','修改')" type="primary" size="mini"
            ...
            <el-button
                ...
                v-if="isAuth('chanpinleixing','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">
              删除
            </el-button>
          </template>
        </el-table-column>
