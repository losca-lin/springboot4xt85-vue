		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 0px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"0px","margin":"0 auto 20px","borderRadius":"3px","textAlign":"center","background":"none","display":"block"}' >
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","lineHeight":"50px","fontSize":"16px","fontWeight":"500","height":"50px"}' class="item-label">原料名称</label>
						<el-input v-model="searchForm.yuanliaomingcheng" placeholder="原料名称" clearable></el-input>
					</div>
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}' class="select" label="原料类别" prop="yuanliaoleibie">
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","lineHeight":"50px","fontSize":"16px","fontWeight":"500","height":"50px"}' class="item-label">原料类别</label>
						<el-select  @change="yuanliaoleibieChange" clearable v-model="searchForm.yuanliaoleibie" placeholder="请选择原料类别">
							<el-option v-for="(item,index) in yuanliaoleibieOptions" v-bind:key="index" :label="item" :value="item"></el-option>
						</el-select>
					</div>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true' prop="yuanliaotupian" width="200" label="原料图片">
						<template slot-scope="scope">
							<div v-if="scope.row.yuanliaotupian">
								<img v-if="scope.row.yuanliaotupian.substring(0,4)=='http'" :src="scope.row.yuanliaotupian.split(',')[0]" width="100" height="100">
								<img v-else :src="$base.url+scope.row.yuanliaotupian.split(',')[0]" width="100" height="100">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
    ...
    getDataList() {
      ...
      let params = {
        ...
        order: 'desc',
           ...
           if(this.searchForm.yuanliaoleibie!='' && this.searchForm.yuanliaoleibie!=undefined){
            params['yuanliaoleibie'] = this.searchForm.yuanliaoleibie
          }
      this.$http({
