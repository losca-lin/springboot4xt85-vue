  ...
  <div class="main-content"
    ...
    <template v-if="showFlag">
      <el-form class="center-form-pv" :style='{"margin":"0 0 0px"}' :inline="true" :model="searchForm">
        <el-row
            :style='{"padding":"0px","margin":"0 auto 20px","borderRadius":"3px","textAlign":"center","background":"none","display":"block"}'>
          <div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
            <label
                :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","lineHeight":"50px","fontSize":"16px","fontWeight":"500","height":"50px"}'
                class="item-label">日期</label>
            <el-date-picker v-model="searchForm.riqistart" type="date" value-format="yyyy-MM-dd" format="yyyy-MM-dd"
                            placeholder="日期起始"></el-date-picker>
            至
            <el-date-picker v-model="searchForm.riqiend" type="date" value-format="yyyy-MM-dd" format="yyyy-MM-dd"
                            placeholder="日期结束"></el-date-picker>
          </div>
          <div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
            <label
                :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","lineHeight":"50px","fontSize":"16px","fontWeight":"500","height":"50px"}'
                class="item-label">员工姓名</label>
            <el-input v-model="searchForm.yuangongxingming" placeholder="员工姓名" clearable></el-input>
          </div>
          <el-button
              :style='{"border":"0px solid #f2cd41","cursor":"pointer","padding":"0 34px","outline":"none","margin":"0 0px 0 10px","color":"#333","borderRadius":"0px","background":"#FFCC33","width":"auto","fontSize":"16px","minWidth":"100px","height":" 50px"}'
...
<!--          </el-button>-->
          ...
          <el-button
              :style='{"border":"0","cursor":"pointer","padding":"0 16px","margin":"0 10px 6px 0","borderColor":"#666","color":"#333","outline":"none","borderRadius":"0px","background":"#f9c535","borderWidth":"0 0 0px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"36px"}'
              v-if="isAuth('chanpinxiaoshouzhangmu','报表')" type="warning" @click="chartDialog()">统计报表
          </el-button>
        </el-row>
      </el-form>
