...
<!--          <el-input v-model="ruleForm.zhiwei" placeholder="职位" clearable :readonly="ro.zhiwei"></el-input>-->
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="工作时长"
                      prop="gzsc">
          <el-input v-model="ruleForm.gzsc" placeholder="工作时长" clearable
                    :readonly="ro.gzsc"></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="工作时长" prop="gzsc">
          <el-input v-model="ruleForm.gzsc" placeholder="工作时长" readonly></el-input>
        </el-form-item>
      </template>
