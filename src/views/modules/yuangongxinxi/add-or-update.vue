  ...
  <div class="addEdit-block"
    ...
    >
      <template>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="入职时间"
                      prop="ruzhishijian">
          <el-date-picker
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.ruzhishijian" label="入职时间"
                      prop="ruzhishijian">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="身份证"
                      prop="shenfenzheng">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="工作总时长"
                      prop="gzzsc">
          <el-input v-model="ruleForm.gzzsc" placeholder="工作总时长" clearable
                    :readonly="ro.gzzsc"></el-input>
        </el-form-item>

        <el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="工作总时长" prop="gzzsc">
          <el-input v-model="ruleForm.gzzsc" placeholder="工作总时长" readonly></el-input>
        </el-form-item>
      </template>
