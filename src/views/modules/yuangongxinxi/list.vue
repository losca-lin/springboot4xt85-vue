...
<!--              v-if="isAuth('yuangongxinxi','新增')" type="success" @click="addOrUpdateHandler()">新增-->
<!--          </el-button>-->
<!--          <el-button-->
<!--              :style='{"border":"0","cursor":"pointer","padding":"0 16px","margin":"0 10px 6px 0","borderColor":"#666","color":"#333","outline":"none","borderRadius":"0px","background":"#f9c535","borderWidth":"0 0 0px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"36px"}'-->
<!--              v-if="isAuth('yuangongxinxi','删除')" :disabled="dataListSelections.length <= 0" type="danger"-->
...
<!--                v-if=" isAuth('yuangongxinxi','查看')" type="success" size="mini"-->
...
<!--                v-if=" isAuth('yuangongxinxi','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">-->
<!--              修改-->
<!--            </el-button>-->
...
<!--                v-if="isAuth('yuangongxinxi','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除-->
<!--            </el-button>-->
<!--          </template>-->
<!--        </el-table-column>-->
      </el-table>
