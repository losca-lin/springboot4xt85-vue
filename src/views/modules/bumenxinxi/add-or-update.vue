<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230329/eff4ea96c952463cb46b9c79d043ce56.gif) fixed,#f6f6f6"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="部门名称" prop="bumenmingcheng">
					<el-input v-model="ruleForm.bumenmingcheng" placeholder="部门名称" clearable  :readonly="ro.bumenmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="部门名称" prop="bumenmingcheng">
					<el-input v-model="ruleForm.bumenmingcheng" placeholder="部门名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="部门负责人" prop="bumenfuzeren">
					<el-input v-model="ruleForm.bumenfuzeren" placeholder="部门负责人" clearable  :readonly="ro.bumenfuzeren"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="部门负责人" prop="bumenfuzeren">
					<el-input v-model="ruleForm.bumenfuzeren" placeholder="部门负责人" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="办公区域" prop="bangongquyu">
					<el-input v-model="ruleForm.bangongquyu" placeholder="办公区域" clearable  :readonly="ro.bangongquyu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="办公区域" prop="bangongquyu">
					<el-input v-model="ruleForm.bangongquyu" placeholder="办公区域" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='bumenfuzeren'){
							this.ruleForm.bumenfuzeren = obj[o];
							this.ro.bumenfuzeren = true;
							continue;
						}
						if(o=='lianxidianhua'){
						...
						if(o=='bangongquyu'){
							this.ruleForm.bangongquyu = obj[o];
							this.ro.bangongquyu = true;
							continue;
						}
				}
